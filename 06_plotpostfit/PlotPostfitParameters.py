...
input_file = '../04_thetaoutput/MLEPostfit.txt'

nuisance_plot(input_file, 'v', 'background-only', 'Parameters_postfit.eps')
#nuisance_plot(input_file, 'v', 'signal + background', 'mle_sigbkg')
